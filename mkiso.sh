...
build_variant() {
    ...
    case $variant in
        ...
        ;;
        xfce*)
            PKGS="$PKGS $XORG_PKGS lightdm lightdm-gtk-greeter xfce4 gnome-themes-standard gnome-keyring network-manager-applet gvfs-afc gvfs-mtp gvfs-smb udisks2 firefox xfce4-pulseaudio-plugin alacritty vlc fish"
        ...
        ;;
		sway)
            PKGS="$PKGS $WAYLAND_PKGS sway waybar wofi alacritty thunar thunar-volman thunar-archive-plugin xarchiver pavucontrol network-manager-applet gvfs file-roller firefox lightdm lightdm-gtk-greeter udisks2 gnome-themes-standard gnome-keyring"
            SERVICES="$SERVICES dbus lightdm NetworkManager polkitd"
