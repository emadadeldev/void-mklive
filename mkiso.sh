...
build_variant() {
    ...
    case $variant in
        ...
        ;;
		sway)
            PKGS="$PKGS $WAYLAND_PKGS sway waybar wofi alacritty thunar thunar-volman thunar-archive-plugin xarchiver pavucontrol network-manager-applet gvfs file-roller firefox lightdm lightdm-gtk-greeter udisks2"
            SERVICES="$SERVICES dbus lightdm NetworkManager polkitd"
