...
build_variant() {
    ...
    case $variant in
        ...
        ;;
		sway)
            PKGS="$PKGS $WAYLAND_PKGS sway waybar alacritty thunar thunar-volman thunar-archive-plugin xarchiver pavucontrol network-manager-applet gvfs file-roller firefox lightdm lightdm-gtk-greeter udisks2 gnome-themes-standard gnome-keyring"
            SERVICES="$SERVICES dbus lightdm NetworkManager polkitd"
